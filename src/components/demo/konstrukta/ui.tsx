...
export const T_MICRO =
  "knst-mono text-[0.6875rem] uppercase leading-[1.5] tracking-[0.18em]";
export const T_META =
  "knst-mono text-[0.6875rem] uppercase leading-[1.5] tracking-[0.16em]";
export const T_SM = "text-[0.8125rem] leading-[1.6]";
export const T_BODY = "text-[0.9375rem] leading-[1.62]";
export const T_LEAD = "text-[1.0625rem] leading-[1.65]";
...
export function SectionHead({
  ...
  return (
    <div data-rise style={{ "--i": i } as React.CSSProperties}>
      ...
      <h2 className="mt-7 max-w-[22ch] text-balance text-[clamp(1.875rem,3.4vw,2.5rem)] font-semibold leading-[1.08] text-[#E7E5E1]">
        {title}
      </h2>
...
export function SpecRow({ k, v }: { k: string; v: string }) {
  return (
    <div className="flex items-baseline justify-between gap-5 border-b border-white/[0.11] py-2.5">
      <dt className="knst-mono shrink-0 text-[0.6875rem] uppercase leading-[1.5] tracking-[0.14em] text-[#9A9791]">
        {k}
      </dt>
      <dd className="knst-mono min-w-0 break-words text-right text-[0.8125rem] leading-[1.45] text-[#E7E5E1]">
        {v}
      </dd>
    </div>
  );
...
export function Tag({ children }: { children: React.ReactNode }) {
  return (
    <span className="knst-mono inline-block border border-white/[0.11] px-2.5 py-1 text-[0.6875rem] uppercase leading-[1.5] tracking-[0.12em] text-[#9A9791] transition-colors duration-[var(--d-ui)] ease-[var(--e-out)]">
      {children}
    </span>
  );
}

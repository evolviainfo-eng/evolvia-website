import { BAND, CONTAINER, SectionHead, SpecRow, Tag } from "./ui";
  ...
  return (
    ...
    >
      <div className={CONTAINER}>
        ...
        <div className="mt-[clamp(36px,5vw,60px)] grid gap-[clamp(28px,4vw,56px)] lg:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)] lg:items-start">
          <div data-rise style={{ "--i": 1 } as React.CSSProperties} className="min-w-0">
            ...
            <p className="knst-mono mt-9 text-[0.62rem] uppercase tracking-[0.18em] text-[#9A9791]">
              Darbo laikas
            </p>
            ...
            <p className="mt-8 max-w-[38ch] text-[0.9rem] leading-[1.6] text-[#9A9791]">
